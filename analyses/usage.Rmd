...
ggplot(usage_by_doy, aes(x = doy, y = n / 1000)) +
  ...
  annotate("label", x = c(rl_available_date, exam_date, resit_date), y = 40, label = c("Start", "Exam", "Resit"))
...
ggplot(usage_by_doy, aes(x = day_of_course , y = n / 1000)) +
  ...
  annotate("label", x = c(rl_available_date - start_date, exam_date - start_date, resit_date - start_date), y = 40, label = c("Start", "Exam", "Resit"))
